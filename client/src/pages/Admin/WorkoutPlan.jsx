...
import { HiTrash, HiMiniPlusCircle, HiEye } from "react-icons/hi2";
  ...
  const handleConfirmModelConfirm = async () => {
    ...
    try {
      const response = await axios.delete(
        `${appConstants.SERVER_URL}/api/workoutPlans/${selectedRecord}`,
        {
          headers: {
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <div className="flex space-x-2">
                        <Link
                          to={`/admin/dashboard?tab=workoutPlanShow&workoutPlanId=${record._id}`}
                        >
